...
import { getSlot } from '../../shared/utils/slot-helper';
import { prefix } from '../../shared/utils';
import { virtualScrollProps, VirtualScrollProps } from './virtual-scroll-types';
...
export default defineComponent({
  ...
  setup(props: VirtualScrollProps, { slots }) {
