...
import { prefix, getSlot, isFunction } from '../../shared/utils';
import { useNamespace } from '../../shared/hooks/use-namespace';
import type { CollapseContainerOptions } from '../../collapse-container/src/typing';
...
export default defineComponent({
  ...
  setup(props, { slots, emit, attrs }) {
    ...
    const prefixCls = useNamespace('description').b();
