...
import { deepMerge, isFunction, isNumber } from '../../shared/utils';
...
const getProps = computed(() => {
  ...
  if (isDetail) {
    ...
    if (!getContainer) {
      opt.getContainer = `.${prefixCls}-layout-content`;
    }
  }
  return opt;
});
...
@prefix-cls: g-basic-drawer;
@prefix-cls-detail: g-basic-drawer__detail;
